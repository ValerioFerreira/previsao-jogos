...
_DEFAULTS: dict[LegalDocumentType, tuple[str, str]] = {
    LegalDocumentType.terms: (
        ...
        "o sistema de créditos, cupons, indicações ou o programa de afiliados; (d) utilizar a "
        ...
        "9.1 Este contrato é regido pelas leis brasileiras. Fica eleito o foro da comarca de "
        "[FORO/COMARCA] para dirimir controvérsias, ressalvado o foro do domicílio do consumidor "
    ...
    LegalDocumentType.privacy: (
        ...
        "1.3 Dados de uso: análises geradas, apostas promocionais, cupons utilizados, indicações, "
        "endereço IP, data/hora de acesso, tipo de dispositivo e navegador.\n\n"
        "1.4 Cookies e tecnologias similares, para manter sessão de login e medir uso da "
        "plataforma (ver seção 6).\n\n"
        "## 2. Para que usamos seus dados\n\n"
        "2.1 Prestar o serviço (gerar análises, processar compras, liquidar apostas promocionais, "
        "emitir nota fiscal); autenticar e proteger sua conta; cumprir obrigações legais e fiscais; "
        "prevenir fraude e uso indevido (ex.: contas duplicadas, abuso de cupons); e, mediante "
        "consentimento específico, enviar comunicações de marketing.\n\n"
        ...
        "## 6. Cookies\n\n"
        "6.1 Usamos cookies essenciais (manter login/sessão) e cookies de medição de uso. Você "
        "pode gerenciar cookies nas configurações do seu navegador; desativar cookies essenciais "
        "pode impedir o funcionamento do login.\n\n"
        "## 7. Seus direitos (art. 18 da LGPD)\n\n"
        "7.1 Você pode solicitar, a qualquer momento: confirmação do tratamento, acesso aos dados, "
        ...
        "indicado na seção 9.\n\n"
        "## 8. Segurança\n\n"
        "8.1 Adotamos medidas técnicas e organizacionais razoáveis para proteger seus dados "
        ...
        "9.1 Para exercer seus direitos ou tirar dúvidas sobre esta Política, entre em contato "
        "pelo e-mail [E-MAIL DO ENCARREGADO/DPO].\n\n"
        "## 10. Alterações\n\n"
        "10.1 Esta Política pode ser atualizada; alterações relevantes exigem novo aceite do "
        "usuário.",
    ),
    LegalDocumentType.lgpd: (
        ...
        "1.3 Operação do programa de indicação entre usuários e do programa de afiliados, "
        "incluindo identificação de quem indicou/foi indicado para fins de crédito de bônus.\n\n"
        "1.4 Envio de comunicações operacionais (confirmação de compra, status de pagamento, "
        "resultado de apostas promocionais) — estas não dependem de consentimento por serem "
        ...
        "revogação deste consentimento, devem ser feitas pelo e-mail [E-MAIL DO ENCARREGADO/DPO], "
    ...
    LegalDocumentType.credits_policy: (
        ...
        "programa de indicação descrito na seção 6.\n\n"
        ...
        "crédito do pacote tenha sido utilizado. Após o uso de qualquer crédito do pacote, ou "
        "decorrido esse prazo, a compra é considerada consumida e não é reembolsável, ressalvado "
        "erro comprovado de cobrança ou defeito do serviço.\n\n"
        ...
        "afiliados (comissão em dinheiro) e não pode ser acumulado de forma fraudulenta (ex.: "
        "contas múltiplas da mesma pessoa).\n\n"
        "## 7. Validade\n\n"
    ...
    LegalDocumentType.promo_regulation: (
        ...
        "aposta por análise; a aposta é imutável após confirmada (sem edição ou cancelamento "
        "posterior).\n\n"
        "## 3. Mecânica\n\n"
        "3.1 Ao gerar a análise de uma partida futura, 1 crédito é reservado (ver Política de "
        "Créditos).\n\n"
        "3.2 O usuário monta sua aposta combinando mercados oferecidos pela própria análise "
        "(ex.: resultado, escanteios, cartões, gols), respeitando o teto de odd combinada de "
        "2,00. Se o usuário não escolher nenhum mercado, o sistema seleciona automaticamente uma "
        "combinação com odd próxima do teto.\n\n"
        "3.3 Após o término oficial da partida (com um intervalo de segurança para consolidação "
        "do resultado oficial via provedor de dados esportivos), o sistema liquida a aposta "
        "automaticamente:\n\n"
        ...
        "liquidação resultam em cancelamento da aposta, estorno revertido quando aplicável, e "
        "podem levar à suspensão da conta, nos termos dos Termos de Uso.\n\n"
        ...
        "— apostas já confirmadas seguem a regra vigente no momento da confirmação.\n\n"
        "## 8. Legislação aplicável\n\n"
        "8.1 Esta promoção é regida pelos mesmos Termos de Uso e Política de Créditos da "
