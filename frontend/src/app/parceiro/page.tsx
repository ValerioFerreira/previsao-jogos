...
import { Loader2, Copy, TrendingUp, Users, ShoppingCart, DollarSign, Sparkles } from "lucide-react";
      ...
      <Card>
        <CardContent className="pt-6 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-semibold text-sm">Conta demo para divulgação</div>
              <p className="text-sm text-muted-foreground">
                Use a conta demo (créditos ilimitados) para mostrar a plataforma para seu público.
              </p>
            </div>
          </div>
          <Link href="/parceiro/conta-demo">
            <Button size="sm" variant="outline">Acessar conta demo</Button>
          </Link>
        </CardContent>
      </Card>
    </div>
