                      ...
                      <table className="w-full text-[12px]">
                        <thead className="text-muted-foreground">
                          <tr className="text-left">
                            ...
                            <th className="py-2 sm:py-1 font-medium text-center"><span className="inline-flex items-center gap-0.5 justify-center">Nota <InfoTooltip text="Nota da partida" /></span></th>
                            <th className="py-2 sm:py-1 font-medium text-center"><span className="inline-flex items-center gap-0.5 justify-center">Min <InfoTooltip text="Minutos jogados" /></span></th>
                            <th className="py-2 sm:py-1 font-medium text-center"><span className="inline-flex items-center gap-0.5 justify-center">G/A <InfoTooltip text="Gols/Assistências" /></span></th>
                            <th className="py-2 sm:py-1 font-medium text-center"><span className="inline-flex items-center gap-0.5 justify-center">Fin. <InfoTooltip text="Finalizações" /></span></th>
                          </tr>
                        </thead>
                        <tbody>
                          {pb.players.map((p, i) => (
